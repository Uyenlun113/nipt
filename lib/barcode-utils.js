...
export function getPackagePrefix(packageType = '') {
  ...
  if (pkg.includes('7') && pkg.includes('20')) return 'GT7-20GA';
  if (pkg.includes('23') && pkg.includes('20')) return 'GT23-20GA';
  if (pkg.includes('plus') && pkg.includes('20')) return 'PLUS-20GA';
  if ((pkg.includes('twin') || pkg.includes('twins')) && pkg.includes('20')) return 'TWIN-20GA';
  if (pkg.includes('20ga') || pkg.includes('20')) return '20GA';
  if (pkg.includes('thal')) return 'THAL';
