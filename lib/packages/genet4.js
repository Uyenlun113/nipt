...
export const genet4PackageHandler = {
  id: 'GeneT 4',
  name: 'GeneT 4',
  templateFileName: 'KQ_NIPT_GENET 4.pdf',
  ...
  async generatePdf(sampleData) {
    const pdfBuffer = getCachedPdfTemplate(this.templateFileName, 'KQ_NIPT_GENNI 4.pdf');
    ...
    firstPage.drawText(conclusionStr, { x: 98, y: 363.2, size: 9, font: fontBold, color: conclusionColor, maxWidth: 450, lineHeight: 13 });
