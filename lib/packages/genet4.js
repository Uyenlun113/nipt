...
export const genet4PackageHandler = {
  ...
  // 1. Default 4 Syndromes (T21, T18, T13, Turner XO)
  getDefaultResults() {
    return {
      t21: { label: 'Trisomy 21 (Down)', value: '0.887', risk: 'Nguy cơ thấp', ref: '-3 < Z < 3' },
      t18: { label: 'Trisomy 18 (Edwards)', value: '0.913', risk: 'Nguy cơ thấp', ref: '-3 < Z < 3' },
      t13: { label: 'Trisomy 13 (Patau)', value: '-0.236', risk: 'Nguy cơ thấp', ref: '-3 < Z < 3' },
      turner: { label: 'HC Turner (45, XO)', value: '-0.260', risk: 'Nguy cơ thấp', ref: '-3 < Z < 3' }
    };
  },
  ...
  async generatePdf(sampleData) {
    ...
    if (dateParts.length === 3) {
      firstPage.drawText(dateParts[0], { x: 417, y: 313.8, size: 9, font: fontBold, color: darkColor });
      firstPage.drawText(dateParts[1], { x: 458, y: 313.8, size: 9, font: fontBold, color: darkColor });
      firstPage.drawText(dateParts[2], { x: 498, y: 313.8, size: 9, font: fontBold, color: darkColor });
    }
