...
export const genet7PackageHandler = {
  ...
  // 1. Default 7 Chromosome Disorder Rows for GeneT 7
  getDefaultResults() {
    return {
      t21: { label: 'Trisomy 21 (Down)', value: '0.696', risk: 'Nguy cơ thấp', ref: '-3 < Z < 3' },
      t18: { label: 'Trisomy 18 (Edwards)', value: '0.998', risk: 'Nguy cơ thấp', ref: '-3 < Z < 3' },
      t13: { label: 'Trisomy 13 (Patau)', value: '0.553', risk: 'Nguy cơ thấp', ref: '-3 < Z < 3' },
      turner: { label: 'HC Turner (45, XO)', value: '0.135', risk: 'Nguy cơ thấp', ref: '-3 < Z < 3' },
      klinefelter: { label: 'HC Klinefelter (47, XXY)', value: '0.135', risk: 'Nguy cơ thấp', ref: '-3 < Z < 3' },
      jacobs: { label: 'HC Jacobs (47, XYY)', value: '0.135', risk: 'Nguy cơ thấp', ref: '-3 < Z < 3' },
      tripleX: { label: 'HC Trisomy X (47, XXX)', value: '0.135', risk: 'Nguy cơ thấp', ref: '-3 < Z < 3' }
    };
  },
  ...
  async generatePdf(sampleData) {
    ...
    if (dateParts.length === 3) {
      firstPage.drawText(dateParts[0], { x: 408, y: 222.9, size: 9, font: fontBold, color: darkColor });
      firstPage.drawText(dateParts[1], { x: 466, y: 222.9, size: 9, font: fontBold, color: darkColor });
      firstPage.drawText(dateParts[2], { x: 518, y: 222.9, size: 9, font: fontBold, color: darkColor });
    }
