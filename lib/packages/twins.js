...
export const twinsPackageHandler = {
  ...
  // 1. Default result fields for Twins (T21, T18, T13)
  getDefaultResults() {
    return {
      t21: { label: 'Trisomy 21 (Down)', value: '-0.505', risk: 'Nguy cơ thấp', ref: '-3 < Z < 3' },
      t18: { label: 'Trisomy 18 (Edwards)', value: '-0.663', risk: 'Nguy cơ thấp', ref: '-3 < Z < 3' },
      t13: { label: 'Trisomy 13 (Patau)', value: '-0.676', risk: 'Nguy cơ thấp', ref: '-3 < Z < 3' }
    };
  },
  ...
  async generatePdf(sampleData) {
    ...
    if (dateParts.length === 3) {
      ...
      firstPage.drawText(dateParts[2], { x: 518, y: 243.7, size: 9, font: fontBold, color: darkColor });
    }
