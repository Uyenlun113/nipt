...
export const package20gaHandler = {
  ...
  async generatePdf(sampleData) {
    ...
    if (pages.length > 1) {
      const dateToUse = formattedReportDate;
      ...
      if (sampleData.checkerName) {
        drawText(page2, sampleData.checkerName, 100, 512.0, 9.5, fontBold, darkColor);
      ...
      if (sampleData.directorName) {
        drawText(page2, sampleData.directorName, 400, 512.0, 9.5, fontBold, darkColor);
