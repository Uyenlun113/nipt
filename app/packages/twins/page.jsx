                  ...
                  {loading ? (
                    <tr>
                      <td colSpan={7} className="py-12 text-center text-slate-400">
                        ...
                        <span>Đang tải danh sách mẫu NIPT GeneT Twins (Song Thai)...</span>
                      </td>
                    </tr>
                  ) : samples.length === 0 ? (
                    <tr>
                      <td colSpan={7} className="py-12 text-center text-slate-400">
                        Chưa có mẫu xét nghiệm NIPT GeneT Twins (Song Thai) nào trong danh sách.
                      </td>
                    </tr>
                  ) : (
                    samples.map((s) => {
                      ...
                      return (
                        <tr key={id} className="hover:bg-slate-50/70 transition-colors">
                          <td className="py-4 px-4 font-mono font-extrabold text-rose-900 text-sm">
                          ...
                          <td className="py-4 px-4 text-slate-700 font-medium">
                            ...
                            <span className="inline-block mt-0.5 px-2 py-0.5 rounded text-[11px] font-bold bg-rose-50 text-rose-800 border border-rose-200">
                          ...
                          <td className="py-4 px-4 text-center">
                            {hasCfDna ? (
                              <span className="px-3 py-1 rounded-lg bg-rose-50 text-rose-900 font-mono font-extrabold text-xs border border-rose-200 shadow-xs">
                                {s.cfDNA}%
                              </span>
                            ) : (
