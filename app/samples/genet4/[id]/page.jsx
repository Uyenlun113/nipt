        ...
        <main className="flex-1 overflow-y-auto p-8 space-y-8 w-full">
          ...
          <div className="flex items-center justify-between pb-4 border-b border-slate-200 w-full">
            ...
            <div className="flex items-center gap-3">
              ...
              <label className="px-4 py-2.5 bg-amber-600 hover:bg-amber-700 text-white rounded-xl text-sm font-extrabold cursor-pointer transition-all flex items-center gap-2 shadow-md shadow-amber-600/20">
