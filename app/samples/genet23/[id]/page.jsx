        ...
        <main className="flex-1 overflow-y-auto p-8 space-y-8 w-full">
          ...
          <div className="flex items-center justify-between pb-4 border-b border-slate-200 w-full">
            ...
            <div className="flex items-center gap-3">
              ...
              <label className="px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-sm font-extrabold cursor-pointer transition-all flex items-center gap-2 shadow-md shadow-indigo-600/20">
                <Upload className="w-4 h-4" />
                <span>{uploading ? 'Đang đọc...' : (formData.originalPdfUrl ? 'Đọc lại / Tải lại PDF' : 'Upload File PDF Kết Quả')}</span>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4 w-full">
              ...
              <div className="pt-5 border-t border-slate-200 flex flex-wrap items-center justify-end gap-3">
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white rounded-xl text-sm font-extrabold shadow-md transition-all flex items-center gap-2"
