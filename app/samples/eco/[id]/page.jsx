...
export default function EcoSampleDetailPage() {
  ...
  const fetchSampleDetail = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        let activeResults = hasCustomResults ? { ...data.results } : defaultEcoResults;
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setMsg({ type: 'success', text: 'Đã lưu thay đổi Mẫu GeneT Eco & cập nhật bản xem trước PDF!' });
    ...
    return (
      <div className="flex h-screen bg-slate-50 items-center justify-center">
        <div className="text-center font-bold text-slate-600 text-sm">
          ...
          Đang tải trang chi tiết Mẫu GeneT Eco...
        </div>
      </div>
    );
  }
              ...
              <div>
                <div className="flex items-center gap-3">
                  <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">
                    Chi Tiết Mẫu GeneT Eco (Phôi 1 Trang)
                  </h1>
                ...
                <p className="text-sm text-slate-500 font-medium mt-0.5">
                  Trang xử lý riêng biệt dành riêng cho Gói Xét Nghiệm NIPT GeneT Eco
                </p>
              </div>
            </div>
          ...
          <div className="w-full space-y-8">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4 w-full">
              <h2 className="text-sm font-extrabold uppercase tracking-wider text-slate-900 border-b border-slate-200 pb-2 flex items-center justify-between">
                ...
                <span className="text-teal-700 font-bold font-mono">Gói: GeneT Eco</span>
              </h2>
            ...
            <div className="bg-teal-50/80 p-5 rounded-2xl border border-teal-200 shadow-sm flex items-center justify-between w-full">
              <div>
                <h3 className="text-sm font-extrabold text-teal-950 uppercase tracking-wider">Hàm lượng cfDNA (%) - Mẫu Eco</h3>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4 w-full">
              ...
              <div className="pt-5 border-t border-slate-200 flex flex-wrap items-center justify-end gap-3">
                ...
                >
                  ...
                  <span>{saving ? 'Đang lưu...' : 'Lưu Mẫu GeneT Eco'}</span>
                </button>
