...
export default function GeneT7SampleDetailPage() {
  ...
  const fetchSampleDetail = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        let activeResults = hasCustomResults ? { ...data.results } : defaultGeneT7Results;
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setMsg({ type: 'success', text: 'Đã lưu thay đổi Mẫu GeneT 7 & cập nhật bản xem trước PDF!' });
  ...
  const section2Keys = Object.keys(resultsObj).filter(k => !section1Keys.includes(k));
              ...
              <div>
                <div className="flex items-center gap-3">
                  <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">
                    Chi Tiết Mẫu GeneT 7 (Extra.pdf - 7 Hội Chứng)
                  </h1>
                  <span className="px-3 py-1 bg-teal-100 text-teal-900 font-mono font-extrabold text-sm rounded-lg border border-teal-200">
                    {formData.sampleCode}
                  </span>
                ...
                <p className="text-sm text-slate-500 font-medium mt-0.5">
                  Trang xử lý riêng biệt dành riêng cho Gói Xét Nghiệm NIPT GeneT 7 (Chỉ chèn Trang 1 phôi)
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              {(formData.status === 'completed' || formData.status === 'extracted' || formData.originalPdfUrl || formData.cfDNA) ? (
                ...
                <label className="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-800 rounded-xl text-sm font-bold cursor-pointer transition-all flex items-center gap-2 border border-slate-300">
                  ...
                  <span>{uploading ? 'Đang đọc...' : 'Upload PDF Kết Quả (Extra.pdf)'}</span>
          ...
          <div className="w-full space-y-8">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4 w-full">
              <h2 className="text-sm font-extrabold uppercase tracking-wider text-slate-900 border-b border-slate-200 pb-2 flex items-center justify-between">
                ...
                <span className="text-teal-700 font-bold font-mono">Gói: GeneT 7</span>
              </h2>
            ...
            <div className="bg-teal-50/80 p-5 rounded-2xl border border-teal-200 shadow-sm flex items-center justify-between w-full">
              <div>
                <h3 className="text-sm font-extrabold text-teal-950 uppercase tracking-wider">Hàm lượng cfDNA (%) - Mẫu GeneT 7</h3>
                <p className="text-xs text-teal-800 font-medium">Tự động trích xuất từ file Extra.pdf ({formData.originalPdfName || 'File kết quả'})</p>
              </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-6 w-full">
              <div className="border-b border-slate-200 pb-2">
                <h3 className="text-sm font-extrabold uppercase tracking-wider text-slate-900">
                  KẾT QUẢ PHÂN TÍCH XÉT NGHIỆM GENET 7
                </h3>
              </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    >
                      ...
                      <span>DƯƠNG TÍNH (Phát hiện)</span>
                    </button>
                  </div>
                </div>
              </div>
            ...
            {/* Section 5: LIVE PDF PREVIEW FRAME FOR GENET 7 (PAGE 1 ONLY) */}
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-md space-y-4 w-full">
              <div className="flex items-center justify-between border-b border-slate-200 pb-3">
                <h3 className="font-extrabold text-base text-slate-900 uppercase tracking-wider flex items-center gap-2">
                  ...
                  <span>Bản Xem Trước Phôi In GeneTrust 7</span>
                </h3>
